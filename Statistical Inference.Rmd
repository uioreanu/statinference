...
As shown in the bell curve graph, the calculated distribution of means of random sampled exponantial distributions overlaps with the normal distribution, due to the **Central Limit Theorem**.
